...
function remote(commandName, options, callback){
  ...
  attachments(function(error, _attachments){
    ...
    logging.info( 'Calling remote command "%s" with following attachments', commandName);
    ...
    request(requestOptions, function(error, response, body){
      ...
      if( response.statusCode == 200 ){
        ...
        body.result.sandbox.messages.push('1','2','3');
        ...
        body.result.sandbox.messages.forEach(function(msg){
          msgs += '\n> ' + msg;
        });
        ...
        logging.info('Result: ', body.result.sandbox.result);
